...
class MagicBitboards {
    ...
    static void initMagics() {
        ...
        for (int i = 0; i < 64; i++) {
            ...
            bishopAmountOfAttackedSquares = Long.bitCount(bishopMask);
            rookAmountOfAttackedSquares = Long.bitCount(rookMask);
    ...
    static long rookFindMagicNumber(int square, int squareAmount) {
        ...
        for (int i = 0; i < 10000000; i++) {
            ...
            if ((Long.bitCount(attackMask * magicNumber & 0xFF00000000000000L)) < 6) continue;
